...
<div class="print-hide" style="width: 30%; margin: 0 auto;" >
    <a class="print-hide" href="<?php echo(base_url("index.php/sales")) ?>">
...
<div id="receipt_wrapper">
	...
	<?php echo "<img id='barcode' src='index.php/barcode?barcode=$sale_id&text=$sale_id&width=250&height=50' />"; ?>
	</div>
	...
	?>
		...
		<td>
            <span class='long_name'><?php echo $item['name']; ?></span>
            <span class='short_name'><?php echo character_limiter($item['name'],10); ?></span>
            <?php if($item['serialnumber']!="")echo "-SN:".$item['serialnumber']; ?>
        </td>
	...
	<tr>
		...
		<td colspan="2" style='text-align:right'><?php echo  (to_currency( to_number($amount_change)*(-1))); ?></td>
	</tr>

	</table>

	<div id="sale_return_policy" style="float: left;">
