...
<ul id="report_list">
	<li class="pull-left"><h3><?php echo $this->lang->line('reports_graphical_reports'); ?></h3>
		<ul>
	...
	<li class="pull-left"><h3><?php echo $this->lang->line('reports_summary_reports'); ?></h3>
		<ul>
	...
	<li class="pull-left"><h3><?php echo $this->lang->line('reports_detailed_reports'); ?></h3>
		<ul>
	...
	<li class="pull-left"><h3><?php echo $this->lang->line('reports_inventory_reports'); ?></h3>
		<ul>
