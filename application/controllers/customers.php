...
class Customers extends Person_controller
{
	...
	*/
    ...
    /*
	Gives company suggestions
	*/
    function suggest_company()
	{
		$suggestions = $this->Customer->get_company_suggestions($this->input->post('q'));
		echo implode("\n",$suggestions);
	}
	...
	*/
    ...
    //clear card number only for lombok pearl
    function reassign_card(){
        $this->Customer->reassign_card();
        $this->index();        
    }
