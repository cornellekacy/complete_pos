...
class Sales extends Secure_area
{
	...
	{		
		...
		if ( $payment_type == $this->lang->line('sales_giftcard') )
		{
			...
			$payment_type=$this->input->post('payment_type').':'.$payment_amount=to_number( $this->input->post('amount_tendered'));
		...
		{
			$payment_amount=to_number($this->input->post('amount_tendered'));
		}
	...
	function edit_item($line)
	{
        ...
        if($this->input->post("price")){
            ...
            $price=$this->Item->get_info($item_id)->unit_price; 
        }
        
		$this->form_validation->set_rules('quantity', 'lang:items_quantity', 'required|numeric');          
        
        $item_data = $this->sale_lib->get_cart();
        $item_id=$item_data[$line]['item_id'];        
